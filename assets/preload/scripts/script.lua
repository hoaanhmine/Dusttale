function onCreate()
    local font = "vcr.TTF"
    local size = {"100", "50"} -- o primeiro valor é o size text da musica, e o segundo o credito / the first value is the song`s size text, the second one is the credits

    local song = songName
    local credit = "Mr. Popo's house pe port - HMFNF APK PORT" -- mude isso para max funny / change here the credits
